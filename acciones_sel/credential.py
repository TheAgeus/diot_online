...
fiels_path = "C:\\Users\\Diot en 0 ext\\Desktop\\Diot en 0 ext online complementaria\\fiel\\"

def get_cer_path(rfc):
    try:
        rfc_folder = [f for f in os.listdir(fiels_path) if rfc in f][0] + "\\"
    except:
        return "Error, no existe la carpeta de fiel."
...
def get_password(rfc):
    try:
        ...
        return "Error con la contraseña. Verifique que exista"
